...
type: "article"
language: "None"
keywords: [Audit, Automation, Conceptual framework, Audit risk, Risk management, Audit trail, Information technology audit, Business process]
...
|------|------|
| **来源** | OpenAlex |
| **DOI** | [10.32628/gisrrj2256239](https://doi.org/10.32628/gisrrj2256239) |
| **发表时间** | 2022-09-01 |
| **期刊** | Gyanshauryam International Scientific Refereed Research Journal |
| **引用次数** | 13 |
| **开放获取** | 是 |
| **类型** | article |
...
- Ijeoma Stephanie Mbonu
- King Chime Aliliele
- Uzoamaka Azuka Iwuanyanwu
- Esther Uzoka
