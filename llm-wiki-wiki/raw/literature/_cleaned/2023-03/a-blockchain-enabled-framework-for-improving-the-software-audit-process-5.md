...
type: "article"
language: "en"
keywords: [Audit, Information security audit, Information technology audit, Operational auditing, Audit plan, Accounting, Business, Internal audit, Computer security, Audit evidence, Internal control, Joint audit, Process management, Computer science, Information security]
...
|------|------|
| **来源** | OpenAlex |
| **DOI** | [10.3390/app13063437](https://doi.org/10.3390/app13063437) |
| **发表时间** | 2023-03-08 |
| **期刊** | Applied Sciences |
| **引用次数** | 25 |
| **开放获取** | 是 |
