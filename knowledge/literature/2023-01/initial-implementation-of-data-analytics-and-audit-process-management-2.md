...
type: "article"
language: "en"
keywords: [Audit, Information technology audit, Audit plan, Generalizability theory, Audit evidence, Big data, Internal audit, Joint audit, Accounting, Walk-through test, Performance audit, Process management, Information security audit, Business, Knowledge management, Computer science, Data mining, Psychology, Computer security, Information security]
...
|------|------|
| **来源** | OpenAlex |
| **DOI** | [10.3390/su15031766](https://doi.org/10.3390/su15031766) |
| **发表时间** | 2023-01-17 |
| **期刊** | Sustainability |
| **引用次数** | 13 |
| **开放获取** | 是 |
