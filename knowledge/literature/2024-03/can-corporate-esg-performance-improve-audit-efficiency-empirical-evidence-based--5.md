...
type: "article"
language: "en"
keywords: [Audit, Accounting, Business, Corporate governance, Performance audit, Corporate social responsibility, Structural equation modeling, Quality audit, Stakeholder theory, Joint audit, Internal audit, Finance, Public relations, Computer science]
...
|------|------|
| **来源** | OpenAlex |
| **DOI** | [10.1371/journal.pone.0299184](https://doi.org/10.1371/journal.pone.0299184) |
| **发表时间** | 2024-03-13 |
| **期刊** | PLoS ONE |
| **引用次数** | 20 |
| **开放获取** | 是 |
