...
type: "article"
language: "en"
keywords: [Audit, Environmental audit, Business, Sustainable development, Accounting, Ecology]
...
|------|------|
| **来源** | OpenAlex |
| **DOI** | [10.3390/su14074268](https://doi.org/10.3390/su14074268) |
| **发表时间** | 2022-04-03 |
| **期刊** | Sustainability |
| **引用次数** | 17 |
| **开放获取** | 是 |
