...
type: "article"
language: "en"
keywords: [Environmental governance, Business, Corporate governance, Promotion (chess), Accountability, Local government, Audit, Government (linguistics), Natural resource, Environmental management system, Context (archaeology), Asset (computer security), Environmental audit, Resource (disambiguation), Environmental resource management, Economics, Accounting, Finance, Public administration, Political science, Ecology]
...
|------|------|
| **来源** | OpenAlex |
| **DOI** | [10.1002/bse.3064](https://doi.org/10.1002/bse.3064) |
| **发表时间** | 2022-04-13 |
