---
source: OpenAlex
doi: "10.17261/pressacademia.2023.1759"
...
type: "article"
language: "en"
keywords: [Audit, Accounting, Business, Scope (computer science), Accounting management, Finance, Transparency (behavior), Financial Audit, Information technology audit, Creditor, Joint audit, Internal audit, Accounting information system, Computer science, Debt]
...
|------|------|
| **来源** | OpenAlex |
| **DOI** | [10.17261/pressacademia.2023.1759](https://doi.org/10.17261/pressacademia.2023.1759) |
| **发表时间** | 2023-09-01 |
| **期刊** | Pressacademia |
| **引用次数** | 7 |
| **开放获取** | 是 |
