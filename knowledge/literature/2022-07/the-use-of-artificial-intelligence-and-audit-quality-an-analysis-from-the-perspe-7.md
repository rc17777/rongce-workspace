...
type: "article"
language: "en"
keywords: [Audit, Walk-through test, Accounting, Joint audit, Quality audit, Perception, Test (biology), Business, Internal audit, Audit evidence, External auditor, Information technology audit, Quality (philosophy), Descriptive statistics, Audit plan, Psychology, Statistics, Mathematics]
...
|------|------|
| **来源** | OpenAlex |
| **DOI** | [10.3390/jrfm15080339](https://doi.org/10.3390/jrfm15080339) |
| **发表时间** | 2022-07-31 |
