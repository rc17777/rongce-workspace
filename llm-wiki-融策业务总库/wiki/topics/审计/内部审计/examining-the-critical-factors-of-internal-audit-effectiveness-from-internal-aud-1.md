...
type: "article"
language: "en"
keywords: [Internal audit, Accounting, Business, Auditor independence, External auditor, Moderation, Public sector, Joint audit, Internal control, Audit, Control environment, Chief audit executive, Public relations, Psychology, Economics, Political science, Social psychology]
...
|------|------|
| **来源** | OpenAlex |
| **DOI** | [10.1016/j.heliyon.2023.e20497](https://doi.org/10.1016/j.heliyon.2023.e20497) |
| **发表时间** | 2023-09-30 |
| **期刊** | Heliyon |
| **引用次数** | 50 |
| **开放获取** | 是 |
